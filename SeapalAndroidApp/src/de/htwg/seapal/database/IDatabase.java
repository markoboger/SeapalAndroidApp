...
public interface IDatabase<T> {
	 ...
	 * 
	 * @param data
	 *            The data entry to save.
	 * @return Returns TRUE, if the data entry was newly created and FALSE when
	 ...
	 * @return The data entry with the given UUID or NULL, if no data was found.
	 */
	T get(UUID id);
	 ...
	 * 
	 * @param id
	 *            The UUID of the data entry to delete.
	 */
	void delete(UUID id);
